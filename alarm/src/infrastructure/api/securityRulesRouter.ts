...
router.route('/:id')
    .get((req: Request, res: Response): void => {
        controller.getSecurityRuleById(req.params.id)
...
router.route('/exceedings')
    .get((req: Request, res: Response): void => {
        controller.getRangeRules()
...
router.route('/exceedings/:id').delete((req: Request, res: Response): void => {
    controller.deleteSecurityRule(req.params.id)
        .then((): void => {
...
router.route('/intrusions')
    ...
    .post((req: Request, res: Response): void => {
        controller.createIntrusionRule(
