...
%
    ...
    %
    In this case, the user can just rely on the camera, monitoring the home or a proprietary field. The user is free to monitor the live video by the camera whenever and wherever he/she wants, using the browser on the smartphone.
    ...
    %
    For example, the director of food wholesale could monitor the temperature of the warehouse and the presence of unauthorised people during the night.
    %
...
%
    ...
    Future developments of this system will certainly have to enrich the user experience in order to exploit all the possible features offered by the system.
