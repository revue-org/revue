...
%
    ...
    In addiction to these containers, four more containers are used to deploy Kafka, Zookeeper, the Media Server and Recognition.
    ...
    Clone Revue from the \href{https://github.com/Mala1180/revue/}{repository} and navigate to the project root.
    ...
    To keep the deployment simplified and the code well organized, an .env file is present in the project root.
    Without modifying the .env file, the services will be exposed on different ports according to the table.
