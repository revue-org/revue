...
export const detectionRouter: Router = express.Router()
const deviceIdFactory: DeviceIdFactory = new DeviceIdFactoryImpl()

detectionRouter.route('/').get((_req: Request, res: Response): void => {
...
detectionRouter.route('/:code').get((_req: Request, res: Response): void => {
  environmentDataController
...
detectionRouter.route('/').post((req: Request, res: Response): void => {
  environmentDataController
...
detectionRouter.route('/').put((req: Request, res: Response): void => {
  environmentDataController
...
detectionRouter.route('/:id').delete((req: Request, res: Response): void => {
  environmentDataController
