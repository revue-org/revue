...
class IntrusionRuleSerializerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.intrusion_rule: IntrusionRule = IntrusionRule(
            ...
            datetime.fromisoformat("2020-01-01T01:00:00.000Z".replace("Z", "+00:00")),
            datetime.fromisoformat("2030-01-01T05:00:00.000Z".replace("Z", "+00:00")),
        )

    def test_deserialize(self):
        self.assertEqual(
            self.intrusion_rule,
            IntrusionRuleSerializer().deserialize(self.intrusion_rule_json),
        )

    def test_serialize(self):
        self.assertEqual(
            self.intrusion_rule_json,
            IntrusionRuleSerializer().serialize(self.intrusion_rule),
        )
